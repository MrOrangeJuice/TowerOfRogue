...
if(!global.floor2Completed) 
{
	...
	if(instance_exists(oPlayer))
	{
		...
		if(oPlayer.x < x + 16 && oPlayer.x > x)
		{
            ...
            draw_text(x+9,y-56,"Reach Floor 3 To Unlock");
            draw_text(x+7,y-56,"Reach Floor 3 To Unlock");
            draw_text(x+8,y-55,"Reach Floor 3 To Unlock");
            draw_text(x+8,y-57,"Reach Floor 3 To Unlock");
