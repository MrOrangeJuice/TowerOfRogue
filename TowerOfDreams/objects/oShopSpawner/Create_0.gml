...
while(!global.shopSpawned)
{
	...
	if(place_meeting(x-1,y,oWall) && place_meeting(x,y+1,oWall) && !place_meeting(x-1,y,oSpikes) && !place_meeting(x,y+1,oSpikes) && !place_meeting(x-1,y,oLava) && !place_meeting(x,y+1,oLava) && !place_meeting(x,y,oNoPipeZone) && !place_meeting(x,y,oWall) && y > oPortal.y)
	{
		randomize();
