...
global.itemFileNames = ["KUNAI","WINGED BOOTS","SHOCK BRACELET","CRIT JELLY","GOBLET OF BLOOD","RAGE COLA","REWARDS CARD","HEART TROPHY","WAX WINGS","LUCKY PICKAXE","GEM MAGNET","BOUNCING AXE","DOOMERANG","CRIT PEANUT BUTTER","BAG OF WINDS","CHARGE BLADE","LIGHTNING BOTTLE","ENCHANTED SHIELD","HEART MAGNET","FUZZY DICE","THE SPRAY N PRAY","GHOST IN A JAR","JESTER BOMB","BLACKSMITH HAMMER","BIRTHDAY SURPRISE","SCOVILLE SCREAMER","HEAVY BOOTS","DIAMOND DYNAMITE","WERE RABBIT FOOT","GEM CANNON","BLOCKATHAN","ARMOR TROPHY","CHAOS SHOVEL","NINJA STAR","SPEED CITRUS","MITOSIS MARACAS","ARMOR","HEART"];
