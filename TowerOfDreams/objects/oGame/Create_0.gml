...
global.item = -1;
global.itemSprites = [sKunaiUI,sBootsUI,sShockUI,sCritUI,sHeart];
global.itemObjects = [oKunaiItem,oBootsItem,oShockItem,oCritItem,oHeart];
global.passiveItems = [];
global.passiveItemSprites = [sShockUI,sCritUI];
global.sword = true;
