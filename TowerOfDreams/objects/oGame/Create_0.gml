...
global.item = -1;
global.itemSprites = [sKunaiUI,sBootsUI,sShockUI,sCritUI,sGobletUI,sColaUI,sCardUI,sHeartTrophyUI,sWingsUI,sPickaxeUI,sMagnetUI,sAxeUI,sBoomerangUI,sCritPBUI,sBagUI,sChargeUI,sLightUI,sShieldUI,sHeartMagnetUI,sFuzzyDiceUI,sSprayUI,sGhostJarUI,sBombUI,sHammerUI,sBirthdayUI,sPepperUI,sArmor,sHeart];
global.itemObjects = [oKunaiItem,oBootsItem,oShockItem,oCritItem,oGobletItem,oColaItem,oCardItem,oHeartTrophyItem,oWingsItem,oPickaxeItem,oMagnetItem,oAxeItem,oBoomerangItem,oCritPBItem,oBagItem,oChargeItem,oLightItem,oShieldItem,oHeartMagnetItem,oFuzzyDiceItem,oSprayItem,oGhostJarItem,oBombItem,oHammerItem,oBirthdayItem,oPepperItem,oArmor,oHeart];
global.passiveItemObjects = [oShockItem,oCritItem,oGobletItem,oColaItem,oCardItem,oHeartTrophyItem,oPickaxeItem,oMagnetItem,oCritPBItem,oBagItem,oChargeItem,oShieldItem,oHeartMagnetItem,oFuzzyDiceItem,oGhostJarItem,oHammerItem,oPepperItem];
global.itemPrices = [120,100,100,100,120,80,100,120,150,100,120,120,120,100,120,120,150,120,80,80,100,100,150,100,120,80,50,50];
global.itemNames = ["Kunai","Winged Boots","Shock Bracelet","Crit Jelly","Goblet of Blood","Rage Cola","Rewards Card","Heart Trophy","Wax Wings","Lucky Pickaxe","Gem Magnet","Bouncing Axe","Doomerang","Crit Peanut Butter","Bag of Winds","Charge Blade","Lightning in a Bottle","Enchanted Shield","Heart Magnet","Fuzzy Dice","The Spray N' Pray","Ghost in a Jar","Jester Bomb","Blacksmith's Hammer","Remote Birthday Surprise","Scoville Screamer","Armor","Heart"];
global.itemTypes = ["Active","Active","Passive","Passive","Passive","Passive","Passive","Passive","Active","Passive","Passive","Active","Active","Passive","Passive","Passive","Active","Passive","Passive","Passive","Active","Passive","Active","Passive","Active","Passive","Pickup","Pickup"];
global.passiveItems = [];
global.passiveItemSprites = [sShockUI,sCritUI,sGobletUI,sColaUI,sCardUI,sHeartTrophyUI,sPickaxeUI,sMagnetUI,sCritPBUI,sBagUI,sChargeUI,sShieldUI,sHeartMagnetUI,sFuzzyDiceUI,sGhostJarUI,sHammerUI,sPepperUI];
global.sword = true;
