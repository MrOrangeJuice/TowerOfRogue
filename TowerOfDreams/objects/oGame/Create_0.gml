...
global.itemFileNames = ["ARMOR TROPHY","BOUNCING AXE","BAG OF WINDS","BIRTHDAY SURPRISE","BLOCKATHAN","JESTER BOMB","DOOMERANG","WINGED BOOTS","GEM CANNON","REWARDS CARD","CHARGE BLADE","SPEED CITRUS","RAGE COLA","CRIT PEANUT BUTTER","CRIT JELLY","DIMAOND DYNAMITE","FUZZY DICE","GHOST IN A JAR","GOBLET OF BLOOD","BLACKSMITH HAMMER","HEART MAGNET","HEART TROPHY","HEAVY BOOTS","KUNAI","LIGHTNING BOTTLE","GEM MAGNET","MITOSIS MARACAS","NINJA STAR","SCOVILLE SCREAMER","LUCKY PICKAXE","WERE RABBIT FOOT","ENCHANTED SHIELD","SHOCK BRACELET","CHAOS SHOVEL","SPRAY N PRAY","WAX WINGS"];
